...
- **Bean Factory**: É a versão mais simples do _ioc container_. Ele ainda existe por questões de compatibilidade com versões antigas ou para usos onde há restrição de memória.
